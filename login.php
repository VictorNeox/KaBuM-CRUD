        ...
        <div class="row container s12 m6 offset-m3">
            ...
            <form class=" col s11 offset-s1">
                ...
                <div class="row login-btn">
                    <button class="btn waves-effect waves-light sign-in-btn" name="submit" type="submit">Entrar</button>
                    <button class="btn waves-effect waves-light sign-in-btn" name="submit" type="submit">Registrar</button>
                </div>
            </form>
        </div>
    </div>
